# ✨ Tier 5: Magical Awakening

**Duration**: Hours 12-24  
**Theme**: Magic, mysticism, and arcane knowledge  
**Goal**: Master magical arts and establish arcane systems

## 📊 Resources

### New Resources
- **Mana** - The essence of magical power
- **Crystals** - For focusing magical energy
- **Essences** - Pure magical elements
- **Runes** - For magical inscriptions and spells
- **Artifacts** - Ancient magical objects
- **Enchanted Materials** - Magically enhanced resources

### Total Resources: 30 (24 from previous tiers + 6 new)
...
### Advanced Actions
- 🔮 **Cast Spell** (Cost: 15 mana, 8 runes, 5 essences → +3 spell effects)
- 🏰 **Create Magical Construct** (Cost: 25 enchanted materials, 15 runes, 10 mana → +1 construct)
- 🌌 **Open Portal** (Cost: 30 mana, 20 crystals, 10 artifacts → +1 portal)
...
- 🔮 **Spell Casting Loop** (Cost: 100 mana, 50 runes, 30 essences → +15 spell effects)
- 🏰 **Construct Creation Loop** (Cost: 150 enchanted materials, 90 runes, 60 mana → +8 constructs)
...
### Advanced Buildings
- **Arcane University** (Cost: 1000 wood, 600 stone, 400 steel, 200 mana)
...
### Advanced Magic
- **Spell Caster** - Cast 500 spells
- **Construct Creator** - Create 100 magical constructs
- **Portal Master** - Open 50 portals
- **Arcane Scholar** - Complete 20 magical research projects
- **Mystical Architect** - Build 25 magical buildings
- **Dimensional Traveler** - Use 100 portals

### Building Achievements
- **Mage Architect** - Build 30 magical buildings
- **Arcane University** - Build 10 arcane universities
- **Portal Network** - Build 20 portal nexuses
- **Mystical Complex** - Build 100 magical buildings
- **Enchantment Master** - Build 50 enchantment chambers

### Resource Achievements
- **Magical Resource Master** - Produce 200000 of each magical resource
- **Mana Master** - Generate 1000000 mana
- **Crystal Empire** - Mine 500000 crystals
- **Essence Collector** - Extract 200000 essences
- **Artifact Hunter** - Discover 10000 artifacts

### Hidden Achievements
- **Magical Revolution** - Complete all magical achievements
- **Arcane Master** - Generate 10000000 mana
- **Crystal King** - Mine 1000000 crystals
...
### Milestone 1: Magical Awakening (12-15 hours)
- Discover magical abilities
- Build Mage Tower
- Master basic mana generation

### Milestone 2: Crystal Mastery (15-18 hours)
- Master crystal mining and essence extraction
- Build Crystal Cave
- Unlock advanced magical research

### Milestone 3: Arcane Arts (18-21 hours)
- Master rune carving and enchantment
- Build Arcane University
- Unlock spell casting systems

### Milestone 4: Mystical Mastery (21-24 hours)
- Master portal creation and dimensional travel
- Build Portal Nexus
- Establish magical networks
- **Unlock Tier 6 progression**

## 📈 Balancing Notes

### Resource Ratios
- Mana:Crystals:Essences = 10:8:6
- Runes:Artifacts:Enchanted = 5:4:3
- Magical resources require 2x base resources + mana

### Time Scaling
- 2-3 hours per milestone
- Total tier completion: 12-24 hours
- Prestige available after 24 hours

### Complexity Management
- 30 total resources (6 new)
- 30 click actions (6 new)
- 8 loop actions (3 new)
- 9 buildings (3 new)
- 4 research projects with magical unlocks
