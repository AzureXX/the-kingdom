...
### Social Events
- **Wandering Trader** 🧳 - A friendly trader passes through with primitive goods
...
### Challenge Events
- **Wild Animal Encounter** 🐺 - A wild animal approaches your camp
...
- **Fiber Discovery** 🌿 - Discover a new type of plant with strong fibers
...
### Learning Events
- **Primitive Invention** 💡 - Have a breakthrough idea while working with tools
