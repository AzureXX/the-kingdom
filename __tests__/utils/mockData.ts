...
export const mockUpgradeCosts = {
  primitiveMastery: { prestige: 5 },
  gatheringExpert: { prestige: 8 },
  buildersWisdom: { prestige: 6 },
  researchAcceleration: { prestige: 10 },
}
